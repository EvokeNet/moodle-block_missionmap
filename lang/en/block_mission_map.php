...
$string['section_select_help'] = 'Select a course section to link this mission to.';
$string['mission_color'] = 'Mission color';
$string['color_picker_help'] = 'Choose a color for your mission dot. This will help distinguish different types of missions.';
$string['mission_completed'] = 'Mission completed';
$string['mission_incomplete'] = 'Mission incomplete';
$string['mission_progress'] = 'Progress: {$a}%';
$string['mission_click_to_access'] = 'Click to access mission';
$string['mission_completed_tooltip'] = '✓ Completed - Click to review';
$string['mission_incomplete_tooltip'] = '○ Incomplete - Click to start';
