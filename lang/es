...
$string['voting_option_course'] = 'Curso en el que buscar secciones';
$string['voting_option_section'] = 'Redirige a esta sección del curso';
...
$string['voting_type_help'] =  '<b>Todos los participantes</b>: Todo miembro alistado en el curso tiene la opción de participar en la votación.<br/><br/><b>Participantes del grupos</b>: Los votos serán contados dentro de cada grupo en este curso.'; // consistency between group-team respect the language in the rest of the platform…

$string['voting_type_all'] = 'Todos los participantes';
$string['voting_type_groups'] = 'Participantes del grupo'; // consistency between group-team respect the language in the rest of the platform…

$string['voting_algorithm'] = 'Mecánica de la votación';
$string['voting_algorithm_help'] = '<b>Mayoría simple</b>: Todos los miembros de la población deben votar. La opción ganadora se decide por mayoría simple. (50% + 1).<br/><br/> <b>Votación limidata por tiempo</b>: No todos los miembros de la población necesita votar. Los votos válidos serán contados si se han emitido antes del límite de tiempo. La opción con la mayoría de votos gana.<br/><br/><b>Umbral de votación</b>: El N% de miembros de la población seleccionado deberán votar. La opción con mayoría simple (50% of N% + 1) gana.<br/><br/><b>Selección aleatoria</b>: La opción ganadora será elegida inmediatamente de manera aleatoria (50% chance of selection).'; // “member of population”… is this students? Agents? Members of a team? Just mentioning this to have clarity on the language. I also have some questions about the random slection option, but this is for another conversation. 
...
$string['voting_tiebreak_help'] = '<b>Segunda ronda</b>: Cada miembro de la población deberá votar por segunda vez antes de un límite de tiempo establecido. La opción ganadora se decide por mayoría simple (50% + 1) o, si no hay votos emitidos, seleccionada de manera aleatoria (50% chance of selection).<br/><br/><b>Votación Minerva</b>: Un “emisor de voto Minerva" seleccionado debería emitir un voto de que decida el desempate antes de un límite de tiempo establecido. Si no hay voto emitido, la opción es elegida de manera aleatoria (50% chance of selection).<br/><br/><b>Selección aleatoria</b>: La opción ganadora será seleccionada inmediatamente de manera aleatoria (50% chance of selection).';

$string['voting_tiebreak_secondround'] = 'Segunda ronda';
$string['voting_tiebreak_minerva'] = 'Votación Minerva'; // I don´t know how this translates…
$string['voting_tiebreak_random'] = 'Selección aleatoria';

$string['voting_minerva'] = 'Emisor de voto Minerva elegido'; // I don´t know how this translates…
...
$string['voting_totalizing'] = 'Esperando los votos del grupo'; // group/team??? Grupo/equipo????
...
// FORMS //formularios (@Jorge Cifuentes, not sure if this is the right translation)
...
$string['form_course_blank'] = 'Seleccionar curso';
$string['form_add_chapter'] = 'Añadir 1 capítulo';
$string['form_supermissions'] = 'Nombre de la supermisión';
$string['form_missions'] = 'Número de misiones en el capítulo'; // not sure if we need one for number of supermissions per chapter too
