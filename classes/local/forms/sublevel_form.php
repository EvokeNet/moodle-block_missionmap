 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sublevel_form extends \moodleform
{
    ...
    {
        parent::__construct(null, $customdata, 'level',  '', ['class' => 'block_mission_map_sublevel_form'], true, $formdata);
    ...
    public function definition()
    {
        ...
        $parentlevelid = !(empty($this->_customdata['parentlevelid'])) ? $this->_customdata['parentlevelid'] : null;
        ...
        $mform->addElement('hidden', 'parentlevelid', $parentlevelid);
